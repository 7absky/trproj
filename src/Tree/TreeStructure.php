        ...
        if (isset($category['parent_cats'][$parent])) {
            ...
            foreach ($category['parent_cats'][$parent] as $cat_id) {
                if (!isset($category['parent_cats'][$cat_id])) {
                    $html .= "<li class='list-group-item'><label>". $category['categories'][$cat_id]['label'] . "<a class='btn btn-xs' href='details.php?id=" .$category['categories'][$cat_id]['id']."'> <span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a></label> <input type='checkbox'/></li>";
                }
                if (isset($category['parent_cats'][$cat_id])) {
                    $html .= "<li class='list-group-item'><label>". $category['categories'][$cat_id]['label'] . "<a class='btn btn-xs' href='details.php?id=" .$category['categories'][$cat_id]['id']."'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a></label> <input type='checkbox'/>";
